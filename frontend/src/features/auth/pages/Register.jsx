        ...
        return (
            <main className="min-h-screen w-full flex items-center justify-center bg-[#0a0f1d]">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <h1 className="text-xl font-medium text-gray-300">Creating your account...</h1>
                </div>
            </main>
        )
    }
            ...
            <div className="w-full max-w-md bg-[#161b22]/70 backdrop-blur-xl border border-[#2a3348] rounded-2xl p-8 shadow-2xl z-10">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-extrabold tracking-tight text-white mb-2">
                        Create <span className="bg-gradient-to-r from-[#ff2d78] to-[#ff6b9d] bg-clip-text text-transparent">Account</span>
                    </h1>
                    <p className="text-gray-400 text-sm">Join to customize and build your winning interview strategy</p>
                </div>

                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    <div className="flex flex-col gap-2">
                        <label htmlFor="username" className="text-xs font-semibold uppercase tracking-wider text-gray-400">Username</label>
                        <input
                ...
                <p className="text-center mt-6 text-sm text-gray-400">
                    Already have an account? <Link to={"/login"} className="text-[#ff2d78] hover:text-[#ff6b9d] font-medium transition-colors">Login</Link>
                </p>
            </div>
        </main>
    )
